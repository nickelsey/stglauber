 ...
 * Added centrality calculation. Real data histogram name can be now specified
...
public:
  ...
  Int_t Scan(const Int_t nevents, const Int_t nppbin, const Double_t nppmin,
             const Double_t nppmax, const Int_t kbin, const Double_t kmin,
             const Double_t kmax, const Int_t xbin, const Double_t xmin,
             const Double_t xmax,
             //        const Double_t x,
             const Double_t efficiency = 1.0,
             //        const Int_t effbin, const Double_t effmin, const Double_t
             //        effmax,
  ...
  void SetParameters(const Double_t npp, const Double_t k, const Double_t x,
                     const Double_t efficiency, const Double_t triggerbias,
  ...
  Double_t GetNormalization(
      const TH1 &h1, const TH1 &h2, const Double_t min,
      const Double_t max) const; // Get normalization factor in (min, max)
  Double_t CalculateChi2(
      const TH1 &hdata, const TH1 &hfunc,
...
private:
  ...
  Bool_t mDoCentralityDetermination; /// Centrality determination flag (default
                                     /// is false)
